...
deps/libbdsg-easy/lib/libbdsg.a:
	cd deps/libbdsg-easy && ${MAKE}

deps/libvgio/build/libvgio.a:
	cd deps/libvgio && rm -rf build && mkdir build && cd build && cmake .. && ${MAKE}

vg2maf : vg2maf.o deps/taffy/lib/libstTaf.a deps/libbdsg-easy/lib/libbdsg.a deps/libvgio/build/libvgio.a
	${CXX} ${CXXFLAGS} -fopenmp -pthread vg2maf.o deps/taffy/lib/libstTaf.a deps/libbdsg-easy/lib/libbdsg.a deps/libvgio/build/libvgio.a -o vg2maf
